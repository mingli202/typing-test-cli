...
- Backspace deletes a typed character, ctrl or alt backspace deletes a word. If it's the start of a word, go to the location of the previous from where you jumped from. E.g. if you typed space in the middle of a word to go to the next word, and backspace, you will be at the letter where you jumped from rather than the end of the previous word.
